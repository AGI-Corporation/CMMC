...
from backend.db.database import AssessmentRecord, Base, ControlRecord, init_db
...
async def run_benchmark():
    ...
    async with AsyncClient(
        ...
        print(
            f"Avg: {statistics.mean(latencies):.2f} ms, P95: {statistics.quantiles(latencies, n=20)[18]:.2f} ms"
        )
