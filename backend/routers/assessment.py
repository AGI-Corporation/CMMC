...
@router.get(
    ...
    description=(
        "Get overall CMMC compliance posture summary including implementation percentages, "
        "SPRS score, and breakdown by domain and level."
    ),
)
...
@router.get(
    ...
    description=(
        "Calculate the DoD Supplier Performance Risk System (SPRS) score based on current "
        "control implementation status. Score ranges from -203 to 110."
    ),
)
