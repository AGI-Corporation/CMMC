...
async def generate_ssp(
    ...
    """
    # Performance: Fetch only needed columns for SSP generation
...
async def generate_poam(
    ...
    """
    # Performance: Fetch only needed columns for POA&M generation
    assessments_dict = await get_latest_assessments(
        db,
        columns=[
            AssessmentRecord.control_id,
...
async def get_dashboard(
    ...
    # Performance: Only need status for dashboard summary counts
    assessments_dict = await get_latest_assessments(
