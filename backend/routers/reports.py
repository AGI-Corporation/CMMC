...
# Mapping of Zero Trust Pillars to CMMC Domains (Centralized)
ZT_PILLAR_DOMAINS = {
    "User": ["AC", "IA", "PS"],
    "Device": ["CM", "MA", "PE"],
    "Network": ["SC", "AC"],
...
def get_maturity_pct(assessments: List[AssessmentRecord], domains: List[str]) -> float:
    """Calculate maturity percentage for a set of CMMC domains."""
    relevant = [
        a
...
| ZT Pillar | CMMC Domains | Maturity Progress |
|-----------|--------------|-------------------|
"""
