...
async def list_controls(
    ...
    # Get filtered control IDs to optimize assessment lookup
    control_ids = [c.id for c in controls_data]

    # Efficiently get latest assessments for filtered controls
    assessments_map = await get_latest_assessments(db, control_ids) if control_ids else {}
