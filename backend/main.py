...
async def http_exception_handler(request: Request, exc: StarletteHTTPException):
    """Log HTTP exceptions (4xx) at INFO level and return them to the client."""
...
async def global_exception_handler(request: Request, exc: Exception):
    """Log unhandled exceptions (500) with full traceback and mask from client."""
    # Ensure we don't accidentally mask Starlette HTTPExceptions if they somehow reach here
