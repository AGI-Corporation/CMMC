...
async def global_exception_handler(request: Request, exc: Exception):
    ...
    Logs the actual error for internal tracking and returns a generic message.
    """
    # Allow FastAPI's built-in exception types to be handled by their respective handlers
