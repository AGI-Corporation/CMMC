...
## 2026-03-28 - Dynamic Pillar Alignment and Data Consistency
**Learning:** In compliance platforms where stakeholders view both high-level dashboards and detailed reports, data inconsistency between these views (e.g., differing Zero Trust pillar definitions) creates confusion and erodes trust. Centralizing domain-to-pillar mappings ensures visual and numerical consistency across the platform.
**Action:** Always centralize categorization logic (like ZT pillar mappings) in a shared constant to ensure report and dashboard parity.
