...
## 2026-03-28 - Navigation in Long Compliance Reports
**Learning:** Long-form compliance documents (like the SSP) can exceed several pages of Markdown. Providing consistent navigation targets like "[↑ Back to Top]" links after major sections significantly improves document usability for human reviewers.
**Action:** Include section-level navigation aids in long-form generated reports.
