...
## 2026-05-09 - Navigation in Long-Form Markdown Documents
**Learning:** Long, non-interactive reports (like Markdown-based SSPs) benefit significantly from 'Back to Top' navigation anchors and summary metadata (e.g., 'Showing X of Y'). These micro-UX touches transform a static document into a more navigable and predictable experience for compliance auditors.
**Action:** Implement internal anchors and dataset summaries in long report generation logic to improve scannability and user orientation.
