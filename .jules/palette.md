...
## 2026-03-28 - Navigation and Metadata in Long Reports
**Learning:** Long, non-interactive reports (like Markdown) benefit significantly from 'Back to Top' navigation anchors and 'Showing X of Y' summary metadata. These elements improve scannability and provide immediate context on the total dataset size without overwhelming the user.
**Action:** Include 'Back to Top' links at the end of major sections and summary counts for list-heavy sections in Markdown reports.
