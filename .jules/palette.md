...
## 2026-03-28 - Markdown Anchor Navigation
**Learning:** Markdown headers automatically generate anchors (e.g., `# Header` becomes `#header`). Using these anchors for "Back to Top" links significantly improves the navigation experience in long, text-heavy reports like the SSP.
**Action:** Include "Back to Top" navigation links in long Markdown reports to improve readability and mobile experience.
