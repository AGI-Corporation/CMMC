...
## 2026-03-28 - Navigational UX in Markdown Reports
**Learning:** Long, non-interactive reports (like Markdown) benefit significantly from 'Back to Top' navigation anchors and 'Showing X of Y' summary metadata. These small additions improve scannability and provide immediate context on dataset size, which is often missing in flat text formats.
**Action:** Include navigation anchors and summary metadata in long generated reports to assist user orientation.
